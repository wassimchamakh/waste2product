        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative mr-4">
                    <button id="notifDropdownBtn" class="relative focus:outline-none">
                    ...
                    <div id="notifDropdown" class="hidden absolute right-0 mt-2 w-80 bg-white rounded shadow-lg z-50">
                        ...
                        <ul class="max-h-64 overflow-y-auto">
                            @forelse(Auth::user()->unreadNotifications as $notification)
                                <li class="px-4 py-2 border-b hover:bg-gray-50">
                                    {{ $notification->data['message'] ?? 'Nouvelle notification' }}<br>
                        ...
                        <div class="p-2 text-center">
                            <a href="{{ route('notifications.index') }}" class="text-green-600 hover:underline">Voir toutes les notifications</a>
                        </div>
                    </div>
                    <script>
