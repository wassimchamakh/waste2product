    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="/evenements" class="nav-link {{ Request::is('evenements*') ? 'text-primary font-medium' : 'text-gray-600 hover:text-primary' }}">
                    Événements
                </a>
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <div class="relative">
                    <button id="user-menu-btn" class="flex items-center space-x-3 p-1 rounded-lg hover:bg-gray-100">
                        ...
                        <div class="text-left">
                            <p class="text-sm font-medium text-gray-900">Leila M.</p>
        ...
        <div class="p-4">
            ...
            <div class="mt-8">
                ...
                <div class="flex items-center space-x-3 p-3 bg-gray-100 rounded-lg mb-4">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900">Leila Gharbi</p>
                        <p class="text-xs text-gray-500">Éco-Warrior 🏆</p>
                    </div>
                </div>
