...
<nav class="bg-white dark:bg-gray-800 shadow-lg fixed w-full top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="/" class="nav-link {{ Request::is('/') ? 'text-primary font-medium' : 'text-gray-600 dark:text-gray-300 hover:text-primary' }}">
                    Accueil
                </a>
                ...
                <a href="/tutoriels" class="nav-link {{ Request::is('tutoriels*') ? 'text-primary font-medium' : 'text-gray-600 dark:text-gray-300 hover:text-primary' }}">
                    Tutoriels
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-4">
                <!-- Notifications -->
                <div class="relative">
                    <button id="notifications-btn" class="text-gray-600 dark:text-gray-300 hover:text-primary p-2 relative">
                        <i class="fas fa-bell text-lg"></i>
                        <div class="notification-dot"></div>
                    </button>
                    
                    <!-- Notifications Dropdown -->
                    <div id="notifications-dropdown" class="hidden absolute right-0 mt-2 w-80 bg-white dark:bg-gray-700 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600 z-50">
                        <div class="p-4 border-b border-gray-200 dark:border-gray-600">
                            <h3 class="font-semibold text-gray-900 dark:text-white">Notifications</h3>
                        </div>
                        <div class="max-h-64 overflow-y-auto">
                            <div class="p-3 hover:bg-gray-50 dark:hover:bg-gray-600 border-b border-gray-100 dark:border-gray-600">
                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 bg-success rounded-full flex items-center justify-center">
                                        <i class="fas fa-check text-white text-sm"></i>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-sm text-gray-900 dark:text-white">Votre projet "Table Basse" a été approuvé !</p>
                            ...
                            <div class="p-3 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 bg-accent rounded-full flex items-center justify-center">
                                        <i class="fas fa-calendar text-white text-sm"></i>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-sm text-gray-900 dark:text-white">Rappel: Repair Café demain à 14h</p>
                ...
                <!-- User Menu -->
                <div class="relative">
                    <button id="user-menu-btn" class="flex items-center space-x-3 p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <!-- User Dropdown -->
                    <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600 z-50">
                        <div class="py-1">
                            <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <a href="/parametres" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <i class="fas fa-cog w-4 mr-3"></i>Paramètres
                            </a>
                            <hr class="my-1 border-gray-200 dark:border-gray-600">
                            <a href="/logout" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600">
    ...
    <div id="mobile-menu" class="mobile-menu md:hidden fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 shadow-xl z-50">
        <div class="p-4">
            ...
            <nav class="space-y-4">
                <a href="/" class="mobile-nav-link block py-3 px-4 rounded-lg {{ Request::is('/') ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300' }}">
                    Accueil
                </a>
                <a href="/dechets" class="mobile-nav-link block py-3 px-4 rounded-lg {{ Request::is('dechets*') ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300' }}">
                    Déchets
                </a>
                <a href="/projets" class="mobile-nav-link block py-3 px-4 rounded-lg {{ Request::is('projets*') ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300' }}">
                    Projets
                </a>
                <a href="/evenements" class="mobile-nav-link block py-3 px-4 rounded-lg {{ Request::is('evenements*') ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300' }}">
                    Événements
                </a>
                <a href="/tutoriels" class="mobile-nav-link block py-3 px-4 rounded-lg {{ Request::is('tutoriels*') ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300' }}">
                    Tutoriels
                </a>
            </nav>
            ...
            <div class="mt-8">
                ...
                <div class="space-y-2">
                    <a href="/dashboard" class="w-full text-left py-3 px-4 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg flex items-center space-x-3">
                        <i class="fas fa-tachometer-alt w-4"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="/profile" class="w-full text-left py-3 px-4 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg flex items-center space-x-3">
                        <i class="fas fa-user w-4"></i>
                        <span>Mon Profil</span>
                    </a>
                    <a href="/mes-projets" class="w-full text-left py-3 px-4 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg flex items-center space-x-3">
                        <i class="fas fa-project-diagram w-4"></i>
                        <span>Mes Projets</span>
                    </a>
                    <a href="/notifications" class="w-full text-left py-3 px-4 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg flex items-center space-x-3">
                        <i class="fas fa-bell w-4"></i>
                        <span>Notifications</span>
                        <span class="ml-auto bg-accent text-white text-xs px-2 py-1 rounded-full">3</span>
                    </a>
                    <a href="/logout" class="w-full text-left py-3 px-4 text-red-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg flex items-center space-x-3">
