...
<footer class="bg-neutral text-white py-8 md:py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div class="text-center sm:text-left">
                <h3 class="font-semibold mb-3 md:mb-4 text-sm md:text-base">Communauté</h3>
                <ul class="space-y-2 text-sm opacity-80">
                    <li><a href="{{ route('forum.index') }}" class="hover:opacity-100 transition-opacity">Forum</a></li>
                    <li><a href="{{ route('login') }}" class="hover:opacity-100 transition-opacity">Se Connecter</a></li>
                    <li><a href="{{ route('register') }}" class="hover:opacity-100 transition-opacity">S'inscrire</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:opacity-100 transition-opacity">Nous Contacter</a></li>
                    <li><a href="{{ route('aide') }}" class="hover:opacity-100 transition-opacity">Centre d'Aide</a></li>
                </ul>
            </div>
